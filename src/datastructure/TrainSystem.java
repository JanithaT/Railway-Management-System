...
public class TrainSystem {
    ...
    public static int getFunction(int func){             
        switch(func){
            ...
            //To Get Passengers for Ticket Queue
            case 1:
                System.out.println("No of passengers in the ticket queue: "+TicketQueue.size()); //No of passengers in the ticket queue
                TrainSystem.TicketQueue=getTicketQueue(TicketQueue);      //Call function to add Passengers for TicketQueue & return the updated current TicketQueue   
                getUserFunc(); //Select Function by the staff again
                break;
            
            //To Provide Ticket to Passengers
            case 2:
                TrainSystem.TicketQueue=provideTicket(TicketQueue);  //Call function to provide Ticket to Passengers & return the updated current TicketQueue            
                getUserFunc(); //Select Function by the staff again
                break;
            
            //To Allow Passengers to enter train
            case 3:
    ...
    //Allow passengers to ticket queue according their valid destination.  Keep maximum 10 passengers in the ticket counter due to the COVID-19 situation
    public static Queue getTicketQueue(Queue TicketQueue){
        ...
        while (true) {
            ...
            if(!TicketQueue.isFull()){             
                ...
                String noSpaceDestination = destination.replaceAll("\\s", "").toLowerCase();  //Convert destination to lowercase and remove space           
    ...
    public static Queue provideTicket(Queue TicketQueue){
        ...
        if(TicketQueue.isEmpty()){        //If ticket queue is empty, display message     
            ...
            System.out.print("\nNo of passengers in the ticket queue: "+TicketQueue.size()+"\nPress Enter"); //Get the no of passengers in the current ticket queue
            ...
            while(true) {
                ...
                if(!TicketQueue.isEmpty()){
                    ...
                    if (input.equals("y")) {      //If want to continue to provide tickets, get passenger's destination,number of tickets, class, no of adults to calculate ticket amount          
    ...
    public static void Wgraph() {
        ...
        System.out.println("vertex 4 - Polgahawela");
